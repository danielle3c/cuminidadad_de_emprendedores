...
<head>
    ...
    <style>
        ...
        /* Navbar */
        .nav-bar { background: var(--primary); padding: 15px; text-align: center; }
        ...
        /* Resultados de Búsqueda con Foto */
        .result-item { 
...
<div class="container">
    ...
    <div class="search-box">
        <form method="GET">
            <input type="text" name="buscar" placeholder="Buscar personas o negocios..." value="<?php echo $_GET['buscar'] ?? ''; ?>">
    ...
    <?php if (isset($_GET['buscar']) && !empty(trim($_GET['buscar']))): ?>
        <div id="resultados">
            ...
            $sql = "SELECT p.*, e.idemprendedores FROM personas p 
                    ...
                    WHERE (p.nombres LIKE '%$busqueda%' OR p.rut LIKE '%$busqueda%') AND p.deleted_at = 0";
            $res = mysqli_query($conexion, $sql);

            while ($f = mysqli_fetch_assoc($res)) { 
                // Avatar dinámico con iniciales si no hay foto real
            ...
            ?>
                <div class="result-item">
                    ...
                    <div class="info-user">
                        ...
                        <p>ID: <?php echo $f['idpersonas']; ?> | RUT: <?php echo $f['rut']; ?></p>
                        <p><?php echo ($f['idemprendedores']) ? "💼 Emprendedor" : "👤 Persona Natural"; ?></p>
                    </div>
                </div>
            <?php } ?>
        </div>
    <?php else: ?>
        <div class="dashboard-grid">
            <a href="personas.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Personas">
                <span>Personas</span>
            </a>
            <a href="emprendedores.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/3135/3135706.png" alt="Negocios">
                <span>Negocios</span>
            </a>
            <a href="contratos.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/3522/3522616.png" alt="Contratos">
                <span>Contratos</span>
            </a>
            <a href="creditos.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/2489/2489756.png" alt="Créditos">
                <span>Créditos</span>
            </a>
            <a href="cobranzas.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/1019/1019607.png" alt="Cobranzas">
                <span>Cobranzas</span>
            </a>
            <a href="carritos.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/1170/1170678.png" alt="Carritos">
                <span>Carritos</span>
            </a>
            <a href="jornadas.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/3652/3652191.png" alt="Jornadas">
                <span>Jornadas</span>
            </a>
            <a href="configuraciones.php" class="menu-card">
                <img src="https://cdn-icons-png.flaticon.com/512/3953/3953226.png" alt="Configuraciones">
                <span>Ajustes</span>
            </a>
        </div>
    <?php endif; ?>

...
// 1. Cargar configuración del tema
...
<div class="container">
    ...
    <div class="card-table">
        ...
        <table>
            ...
            <tbody>
                <?php
                // CONSULTA CORREGIDA: Sin JOIN, directa a la tabla carritos
                ...
                if(mysqli_num_rows($res) > 0) {
                    ...
                    echo "<tr><td colspan='5' style='text-align:center; padding:30px;'>No hay registros guardados.</td></tr>";
                }
                ?>
            </tbody>
        </table>
